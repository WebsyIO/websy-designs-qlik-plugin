...
class Table3 {
  ...
  transformPivotTable (page) {    
    ...
    function expandLeft (input, level, index, parent, chain) {
      ...
      o.qlikRowIndex = leftKeys[this.layout.qHyperCube.qIndentMode !== true ? level : 0].length + this.qlikTop
      input.qlikRowIndex = leftKeys[this.layout.qHyperCube.qIndentMode !== true ? level : 0].length + this.qlikTop      
