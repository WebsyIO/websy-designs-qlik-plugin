...
class Table3 {
  constructor (elementId, options) {
    ...
    this.dropdowns = []
    this.searchPrepped = false
    this.table = new WebsyDesigns.WebsyTable3(this.elementId, Object.assign({}, {
      onClick: this.handleClick.bind(this),
      onScroll: this.handleScroll.bind(this),      
      onSort: this.handleSort.bind(this),
      onChangePageSize: this.setPageSize.bind(this),
  ...
  render (pageNum = 0) {    
    ...
    this.options.model.getLayout().then(layout => {    
      ...
      if (this.layout.qHyperCube.qGrandTotalRow && this.layout.totals && this.layout.totals.show === true) {
        if (this.layout.qHyperCube.qMode === 'S') {
          totals = this.layout.qHyperCube.qDimensionInfo.map(d => ({ value: '' })).concat(this.layout.qHyperCube.qGrandTotalRow.map(t => Object.assign({}, t, { value: t.qText })))
          totals.splice(0, 1, { value: this.layout.totals.label || totals })
        }
      }
      this.table.options.totals = totals
      let activeDimensions = this.layout.qHyperCube.qDimensionInfo        
        .filter(c => !c.qError)        
